...
// `short` is for menu rows that show the active model inline; `label` is the
// full description shown in the picker itself.
export const NEMO_MODELS = {
  "": { short: "Nemotron 3.5", label: "Default (Nemotron 3.5 - multilingual)" },
  "parakeet-tdt": {
    short: "Parakeet TDT",
    label: "Parakeet TDT 0.6B v3 (English, best accuracy)",
  },
  "nemotron-en": { short: "Nemotron EN", label: "Nemotron English streaming" },
  "parakeet-ctc": { short: "Parakeet CTC", label: "Parakeet CTC 1.1B (English)" },
};
