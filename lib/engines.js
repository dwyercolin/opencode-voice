...
// 3.5 is the multilingual CLI default. Each model is its own ~700 MB-1.1 GB
...
export const NEMO_MODELS = {
  ...
  "parakeet-tdt": {
    short: "Parakeet TDT",
    detail: "0.6B v3, English, best accuracy",
...
// English one-shot dictation. /stt-model switches to the multilingual one.
