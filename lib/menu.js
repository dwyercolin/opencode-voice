 ...
 * picker reached from another screen gets one: escape is the only other way
 * out and it closes the whole dialog, so changing two settings meant running
 * /voice twice. Appended in place and returned for chaining; a screen with no
 * parent passes no `back` and keeps its list unchanged.
 */
