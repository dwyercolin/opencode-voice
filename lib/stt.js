    ...
    api.ui.dialog.replace(() =>
      api.ui.DialogSelect({
        ...
        options: [
          ...
          {
            title: "Tap (press to start, press again to finish)",
            value: "tap",
            onSelect() {
              setVoiceMode("tap");
              api.ui.dialog.clear();
    ...
    api.ui.dialog.replace(() =>
      api.ui.DialogSelect({
        ...
        options: [
          ...
          {
            title: `Auto-submit after dictation: ${autoSubmitEnabled() ? "ON" : "OFF"}`,
            value: "autosubmit",
            onSelect() {
              kv.set("voice.autosubmit", !autoSubmitEnabled());
              toast(`Auto-submit ${autoSubmitEnabled() ? "disabled" : "enabled"}`);
              showVoiceMenu();
            },
          },
          {
